<template>
  <div role="region" :aria-label="`Question ${index + 1} editor`">
    <v-row>
      <v-col cols="12" md="8">
        <v-text-field
          ...
          :aria-describedby="question.description ? `question-${index}-description` : undefined"
    ...
    <div v-if="hasOptions" class="mb-4" role="group" aria-label="Question options">
    ...
    <div v-if="question.type === 'number'" class="mb-4" role="group" aria-label="Number field settings">
      <v-row>
        <v-col cols="6">
          <v-text-field
    ...
    <div v-if="question.type === 'text'" class="mb-4" role="group" aria-label="Text field settings">
      <v-row>
        <v-col cols="6">
          <v-text-field
