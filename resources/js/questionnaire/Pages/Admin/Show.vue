    ...
    <v-container>
          ...
          <v-card>
            <v-card-text class="d-flex gap-4 align-center">
              <div class="flex-grow-1">
                ...
                <span v-if="questionnaire.published_at" class="ml-4 text-grey">
                  Published: {{ formatDate(questionnaire.published_at) }}
                </span>
              </div>
              <v-btn
      ...
      <v-row class="mb-4">
        <v-col cols="12" md="3">
          <v-card>
            <v-card-text class="text-center">
              <div class="text-h3">{{ statistics.total_responses }}</div>
        ...
        <v-col cols="12" md="3">
          <v-card>
            <v-card-text class="text-center">
              <div class="text-body-1">{{ formatDate(statistics.first_response_at) || '-' }}</div>
        ...
        <v-col cols="12" md="3">
          <v-card>
            <v-card-text class="text-center">
              <div class="text-body-1">{{ formatDate(statistics.last_response_at) || '-' }}</div>
              ...
              <v-list>
                ...
                >
                  ...
                  <v-list-item-subtitle>
                    ...
                    <v-chip v-if="question.required" size="x-small" color="error">Required</v-chip>
                  </v-list-item-subtitle>
                </v-list-item>
              </v-list>
            </v-card-text>
...
const publish = () => {
  ...
  router.post(`/questionnaire/admin/${props.questionnaire.id}/publish`, {}, {
...
const close = () => {
  closing.value = true;
  router.post(`/questionnaire/admin/${props.questionnaire.id}/close`, {}, {
