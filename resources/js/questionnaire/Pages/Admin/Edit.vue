                        ...
                        <v-card class="mb-4">
                            ...
                            <v-card-text>
                                <v-alert
                                    ...
                                    class="mb-4"
                                >
                                    Questions can only be modified when the
                                    questionnaire is in draft status.
                                </v-alert>
...
<script setup>
    ...
    const form = useForm({
        ...
        duplicate_submission_strategy:
            props.questionnaire.duplicate_submission_strategy ||
            'allow_multiple',
        starts_at: props.questionnaire.starts_at
            ? formatDateForInput(props.questionnaire.starts_at)
            : null,
        ends_at: props.questionnaire.ends_at
            ? formatDateForInput(props.questionnaire.ends_at)
            : null,
